      ...
      <div className="flex flex-grow justify-between pb-4 px-8 text-white bg-black">
        ...
        <div className="flex flex-col gap-2 items-center w-1/3">
          ...
          <div className="w-full px-2 gap-2 flex flex-col">
            ...
            <div className="flex justify-center">WEEKLY NEWSLETTER</div>
            <div className="flex flex-col">
              <input
                placeholder="Name@gmail.com"
                className="border-2 rounded-t-sm text-center border-gray-500"
              />
              <button className="border-2 text-center rounded-b-sm border-gray-500 border-t-0">
                Subscribe
              </button>
            </div>
          </div>
